from UI.acftable import acftable_Form
from PyQt5.QtWidgets import *
import pymysql

class Acftable_Form(QWidget, acftable_Form):
    def __init__(self):
        super(Acftable_Form, self).__init__()
        self.setupUi(self)


    def load(self,acf_list):
        rows=acf_list
        row_num=len(rows)
